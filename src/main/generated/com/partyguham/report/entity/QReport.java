...
public class QReport extends EntityPathBase<Report> {
    ...
    private static final long serialVersionUID = -123501690L;
    ...
    public QReport(Class<? extends Report> type, PathMetadata metadata, PathInits inits) {
        ...
        this.reporter = inits.isInitialized("reporter") ? new com.partyguham.user.account.entity.QUser(forProperty("reporter"), inits.get("reporter")) : null;
    }
