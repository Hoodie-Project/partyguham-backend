package com.partyguham.notification.template;

public enum NotificationTemplate {
    // 파티 상태 변경
    PARTY_FINISHED_FOR_MEMBERS(
            "파티가 성공적으로 종료되었어요",
                    "파티가 성공적으로 종료되었어요. 참여해 주셔서 감사합니다."
    ),
    PARTY_REOPENED_FOR_MEMBERS(
            "파티가 다시 활성화되었어요",
                    "파티가 다시 활성화되었어요. 다시 새로운 도전을 시작해 보세요."
    ),
    PARTY_INFO_UPDATED_FOR_MEMBERS(
            "파티 정보가 업데이트되었어요",
    ...
    PARTY_NEW_MEMBER_JOINED_FOR_MEMBERS(
            "새로운 파티원이 합류했어요",
                    "%s님이 새롭게 파티에 합류했어요. 함께 파티를 시작해 보세요!"
    ),
    PARTY_APPLICANT_ACCEPTED_FOR_APPLICANT(
            "지원이 수락되었어요",
                    "%s님의 지원이 수락되었어요. 합류 여부를 결정해 주세요."
    ),
    PARTY_APPLICANT_REJECTED_FOR_APPLICANT(
            "지원이 거절되었어요",
                    "%s님의 지원이 거절되었어요."
    ),
    PARTY_RECRUITMENT_CLOSED_FOR_APPLICANT(
            "지원한 모집 공고가 마감되었어요",
                    "지원하신 파티 모집공고가 마감되었습니다."
    ),
    PARTY_APPLICANT_DECLINED_FOR_HOST(
            "지원자가 합류를 거절했어요",
